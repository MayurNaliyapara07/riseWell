                    ...
                    <div class="tab-pane fade show active" id="step3" role="tabpanel" aria-labelledby="step3-tab">
                        ...
                        <form action="{{route('save-trt-step-three-refill')}}" method="post" enctype="multipart/form-data"
                                ...
                                <ul class="flex-radio">
                                    <li>
                                        <input type="radio" name="future_children" id="yes1" value="Yes"
                                               ...
                                               {{ !empty($patient) && $patient->future_children == 1 ? 'checked' : ''}} class="css-radio required">
                                        <label for="yes1" class="css-label">Yes</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="future_children"
                                               data-msg-required="Future children is required"
                                               id="no1" value="No" {{!empty($patient) && $patient->future_children == 0 ? 'checked' : '' }} class="css-radio required">
                                ...
                                <ul class="flex-radio">
                                    <li>
                                        <input type="radio" name="living_children" id="Yes2"
                                               ...
                                               {{ !empty($patient) && $patient->living_children == 1 ? 'checked' : ''}} >
                                        <label for="Yes2" class="css-label">Yes</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="living_children" id="No2"
                                               data-msg-required="Children under the age of 5 years living in the home is required"
                                               value="No" {{ !empty($patient) && $patient->living_children == 0 ? 'checked' : ''}} class="css-radio required">
                            ...
                            <div class="radio-area">
                                ...
                                <ul class="flex-radio">
                                    <li>
                                        <input type="radio" name="cream_and_gel" id="Yes3" value="Yes" {{ !empty($patient) && $patient->cream_and_gel == 1 ? 'checked' : ''}} class="css-radio required"
                                               data-msg-required="Testosterone is required">
                                        <label for="Yes3" class="css-label">Yes</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="cream_and_gel" id="No3" value="No"  {{ !empty($patient) && $patient->cream_and_gel == 0 ? 'checked' : ''}} class="css-radio required"
                                               data-msg-required="Testosterone is required">
                            ...
                            <div class="radio-area">
                                ...
                                <ul class="flex-radio">
                                    <li>
                                        <input type="radio" name="allergies" id="Yes4" value="Yes" {{ !empty($patient) && $patient->allergies == 1 ? 'checked' : ''}} class="css-radio required" data-msg-required="Allergies is required">
                                        <label for="Yes4" class="css-label">Yes</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="allergies" id="No4"  value="No" {{ !empty($patient) && $patient->allergies == 0 ? 'checked' : ''}} class="css-radio required" data-msg-required="Allergies is required">
                            ...
                            <div class="radio-area">
                                ...
                                <ul class="flex-radio">
                                    <li>
                                        <input type="radio" name="herbal_or_vitamin" id="Yes5" value="Yes" {{ !empty($patient) && $patient->herbal_or_vitamin == 1 ? 'checked' : ''}} class="css-radio required" data-msg-required="Prescription is required">
                                        <label for="Yes5" class="css-label">Yes</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="herbal_or_vitamin" id="No5" value="No" {{ !empty($patient) && $patient->herbal_or_vitamin == 0 ? 'checked' : ''}} class="css-radio required" data-msg-required="Prescription is required">
                            ...
                            <div class="radio-area">
                                ...
                                <ul class="flex-radio">
                                    <li>
                                        <input type="radio" name="medications_prescribed" id="Yes6" value="Yes" {{ !empty($patient) && $patient->medications_prescribed == 1 ? 'checked' : ''}} class="css-radio required" data-msg-required="Medications is required">
                                        <label for="Yes6" class="css-label">Yes</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="medications_prescribed" id="No6" value="No" {{ !empty($patient) && $patient->medications_prescribed == 0 ? 'checked' : ''}} class="css-radio required" data-msg-required="Medications is required">
