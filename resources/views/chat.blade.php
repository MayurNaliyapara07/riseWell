        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class=" container ">
                ...
                <div class="d-flex flex-row">
                    <!--begin::Aside-->
                    <div class="flex-row-auto offcanvas-mobile w-350px w-xl-400px offcanvas-mobile-on"
                         id="kt_chat_aside">
                        <!--begin::Card-->
                        ...
                        <span class="input-group-text">
                             <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Search.svg--><svg
        ...
        <path d="M11,16 C13.7614237,16 16,13.7614237 16,11 C16,8.23857625 13.7614237,6 11,6 C8.23857625,6 6,8.23857625 6,11 C6,13.7614237 8.23857625,16 11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18 11,18 Z"
              fill="#000000" fill-rule="nonzero"></path>
                                ...
                                <div class="mt-7 scroll scroll-pull ps ps--active-y"
                                     style="height: 111px; overflow: hidden;">
                                    <!--begin:User-->
                                    ...
                                    <div class="ps__rail-y" style="top: 0px; height: 111px; right: -2px;">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M5,2 L17,2 C18.6568542,2 20,3.34314575 20,5 L20,19 C20,20.6568542 18.6568542,22 17,22 L5,22 C4.44771525,22 4,21.5522847 4,21 L4,3 C4,2.44771525 4.44771525,2 5,2 Z M12,11 C13.1045695,11 14,10.1045695 14,9 C14,7.8954305 13.1045695,7 12,7 C10.8954305,7 10,7.8954305 10,9 C10,10.1045695 10.8954305,11 12,11 Z M7.00036205,16.4995035 C6.98863236,16.6619875 7.26484009,17 7.4041679,17 C11.463736,17 14.5228466,17 16.5815,17 C16.9988413,17 17.0053266,16.6221713 16.9988413,16.5 C16.8360465,13.4332455 14.6506758,12 11.9907452,12 C9.36772908,12 7.21569918,13.5165724 7.00036205,16.4995035 Z"
              fill="#000000"></path>
                            ...
                            <span class="svg-icon svg-icon-lg"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="label label-light-danger label-rounded font-weight-bold">5</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="scroll scroll-pull ps ps--active-y" data-mobile-height="350"
                                    ...
                                    <div class="ps__rail-y" style="top: 0px; height: 370px; right: -2px;">
                            ...
                            <div class="card-footer align-items-center">
                                ...
                                <textarea class="form-control border-0 p-0" id="content" rows="2" name="content"
                                          placeholder="Type a message"></textarea>
                                <input type="hidden" id="patients_id" name="patients_id"
                                       value="{{!empty($getPatientDetails)?$getPatientDetails->patients_id:''}}">
                                <input type="hidden" id="phone_no" name="phone_no"
                                       value="{{!empty($getPatientDetails)?$getPatientDetails->country_code.$getPatientDetails->phone_no:''}}">
                                <div class="d-flex align-items-center justify-content-between mt-5">
                                    <div class="mr-3">
                                        <a href="#" class="btn btn-clean btn-icon btn-md mr-1"><i
                                                    class="flaticon2-photograph icon-lg"></i></a>
                                        <button class="btn btn-clean btn-icon btn-md"><i
                                                    class="flaticon2-photo-camera  icon-lg"></i></button>
                                    </div>
                                    <div>
