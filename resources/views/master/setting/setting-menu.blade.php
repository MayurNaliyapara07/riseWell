    ...
    <div class="card card-custom card-stretch">
        ...
        <div class="card-body pt-4">
            ...
            <div class="d-flex align-items-center">
                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                    <div class="symbol-label" style="background-image:url('{{ $profileLogo }}')"></div>
                    <i class="symbol-badge bg-success"></i>
                </div>
                <div>
                    <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">
                        {{!empty($current_user) ? $current_user->first_name." ".$current_user->last_name:''}}
                    </a>
                    <div class="text-muted">
                        <span
                            class="label label-light-primary label-inline font-weight-bold">{{!empty($current_user)?$current_user->user_type:''}}</span>
                    </div>
            ...
            <div class="py-9">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <a href="#"
                       class="text-muted text-hover-primary">{{!empty($current_user)?$current_user->email:''}}</a>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="font-weight-bold mr-2">Phone:</span>
                    <span class="text-muted">{{!empty($current_user)?$current_user->phone_no:''}}</span>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                    <span class="font-weight-bold mr-2">Location:</span>
                    <span
                        class="text-muted">{{!empty($current_user)?Str::limit($current_user->address,25,'.'):''}}</span>
                </div>
            </div>
            <!--end::Contact-->
            <!--begin::Nav-->
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                <div class="navi-item mb-2">
                    <a href="{{url('setting')}}" class="navi-link py-4 {{ request()->is('setting') ? 'active' : '' }}">
                        ...
                        <span class="navi-text font-size-lg">Profile Settings</span>
                    </a>
                </div>
                <div class="navi-item mb-2">
                    <a href="{{route('user-change-password')}}" class="navi-link py-4 {{ request()->is('user-change-password*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
                ...
                <div class="navi-item mb-2">
                    <a href="{{route('general-setting')}}" class="navi-link py-4 {{ request()->is('general-setting*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <path
            ...
            fill="#000000"/>
                ...
                <div class="navi-item mb-2">
                    <a href="{{route('email-setting')}}" class="navi-link py-4 {{ request()->is('email-setting*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <path
            ...
            fill="#000000"/>
                ...
                <div class="navi-item mb-2">
                    <a href="{{route('sms-setting')}}" class="navi-link py-4 {{ request()->is('sms-setting*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero"/>
                        ...
                        <span class="navi-text font-size-lg">SMS Settings</span>
                        <span class="navi-label">
                ...
                <div class="navi-item mb-2">
                    <a href="{{route('payment-gateway-setting')}}" class="navi-link py-4 {{ request()->is('payment-gateway-setting*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                        ...
                        <span class="navi-text font-size-lg">Payment Gateway</span>
                        <span class="navi-label">
                ...
                <div class="navi-item mb-2">
                    <a href="{{route('zoom-setting')}}" class="navi-link py-4 {{ request()->is('zoom-setting*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                        ...
                        <span class="navi-text font-size-lg">Zoom Gateway</span>
                        <span class="navi-label">
...
{{--                <div class="navi-item mb-2">--}}
{{--                    <a href="{{route('order-setting')}}" class="navi-link py-4  {{ request()->is('order-setting*') ? 'active' : '' }}">--}}
{{--															<span class="navi-icon mr-2">--}}
{{--																<span class="svg-icon">--}}
{{--																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->--}}
{{--																	<svg xmlns="http://www.w3.org/2000/svg"--}}
...
{{--																</span>--}}
{{--															</span>--}}
{{--                        <span class="navi-text font-size-lg">Order Settings</span>--}}
{{--                        <span class="navi-label">--}}
...
{{--                </div>--}}
                <div class="navi-item mb-2">
                    <a href="{{route('order-shipping-setting')}}" class="navi-link py-4  {{ request()->is('order-shipping-setting*') ? 'active' : '' }}">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <path
            ...
            fill="#000000"></path>
                        ...
                        <span class="navi-text font-size-lg">Order Shipping Settings</span>
                        <span class="navi-label">
