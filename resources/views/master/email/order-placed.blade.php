...
<body>
<?php
$baseHelper = new \App\Helpers\BaseHelper();
...
<section class="wrapper-invoice">
    ...
    <div class="invoice">
        <div class="invoice-information">
            ...
            <p><b>Order Status</b> : {{!empty($order)?$order->status:''}}</p>
            <p><b>Order Track</b> : <a href="{{!empty($order)?$order->traking_url:''}}">Link</a></p>
        </div>
        <!-- logo brand invoice -->
        ...
        <div class="invoice-head">
            ...
            <div class="head client-data">
                ...
                <p><span>Address: </span> {{!empty($address->line1)?$address->line1:''}},{{!empty($address->line2)?$address->line2:''}}</p>
