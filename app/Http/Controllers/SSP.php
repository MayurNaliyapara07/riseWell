...
class SSP
{
    ...
    public static function complexEOT($request, $table, $primaryKey, $columns, $whereResult = null, $whereAll = null, $orderBy = null)
    {
        ...
        return [
            ...
            'recordsFiltered' => intval(! empty($recordsFiltered) ? $recordsFiltered : ''),
            'data' => self::data_output($columns, $data),
        ];
    }
